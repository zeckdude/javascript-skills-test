...
import { regexAnswers } from '../code/regex';

describe('regular expressions', () => {
  it('should be able to detect a number in a string', () => {
    expect(regexAnswers.containsNumber('abc123')).to.eql(true);
    expect(regexAnswers.containsNumber('abc')).to.eql(false);
  });

  it('should be able to detect a repeating letter in a string', () => {
  ...
  it('should be able to determine whether a string ends with a vowel (aeiou)', () => {
  ...
  it('should be able to capture the first series of three numbers', () => {
  ...
  it('should be able to determine whether a string matches a pattern', () => {
  ...
  it('should be able to detect correctly-formatted monetary amounts in USD', () => {
