...
import { arraysAnswers } from '../code/arrays';
...
describe('arrays', () => {
  ...
  it('should be able to determine the location of an item in an array', () => {
    expect(arraysAnswers.indexOf(a, 3)).to.eql(2);
    expect(arraysAnswers.indexOf(a, 5)).to.eql(-1);
  });

  it('should be able to sum the items of an array', () => {
    expect(arraysAnswers.sum(a)).to.eql(10);
  });

  it('should be able to remove all instances of a value from an array', () => {
  ...
  it('should be able to add an item to the end of an array', () => {
  ...
  it('should be able to remove the last item of an array', () => {
  ...
  it('should be able to add an item to the beginning of an array', () => {
  ...
  it('should be able to remove the first item of an array', () => {
  ...
  it('should be able to join together two arrays', () => {
    const c = ['a', 'b', 'c', 1];
  ...
  it('should be able to count the occurrences of an item in an array', () => {
  ...
  it('should be able to square each number in an array', () => {
